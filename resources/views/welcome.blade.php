...
<body class="bg-white">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item tw-flex tw-items-center">
                        <a class="btn  tw-bg-[#005CBB] text-white  tw-rounded-r-none tw-rounded-l-lg" href="{{ route('login') }}">
                            Login
                        </a>
                        <a class="btn  tw-rounded-r-lg tw-shadow tw-rounded-l-none tw-text-[#005CBB]" href="{{route('register')}}">
                            SignUp
                        </a>
                    </li>
    ...
    <div class="nav-links tw-bg-[#F7F7F7] tw-py-5">
        <div class="container">
            <ul class="nav justify-content-between">
                ...
                <li class="nav-item">
                    <a class="nav-link tw-text-gray-500" href="#">
                        Publications
                    </a>
                </li>
                <li class="nav-item">
            ...
            <div class="tw-grid md:tw-grid-cols-2 tw-mt-10">
                ...
                <div style="background-image: url({{ asset("assets/img/lady_back.jpeg") }});background-repeat: no-repeat;background-position: center;background-size: cover">
    ...
    <div class="container my-5">
        <div class="card card-body p-5 tw-bg-[#F7F7F7] position-relative border-0 rounded-0 mx-md-5">
            <button class="btn text-white px-5 rounded-0 position-absolute bg-primary d-flex justify-content-between tw-z-10 -tw-top-[20px]">
    ...
    <div class=" position-relative overflow-hidden">
        ...
        <div class="container">
            ...
            <a href="" class="btn tw-rounded-none bg-primary btn-lg text-white tw-pr-10 mx-md-5 mx-2 px-5" style="margin-left: 120px;">
                Programs
            </a>
                ...
                <div class="card border-0 rounded-0 me-5">
                    ...
                    <div class="card-body px-0 ">
                        <div class="card-text small position-relative">
                            ...
                            <a href="#" style="bottom:0;right:0" class="px-3 small text-right text-warning my-2 border-left py-0 rounded-0 ml-2 position-absolute">
                                <br> Apply
                                Now</a>
                        </div>
                        ...
                        <div class="col-md-8">
                            <div class="card-body py-md-0 px-0 mx-md-4 border-bottom tw-border-[#005CBB] tw-border-2 tw-h-full">
                                ...
                                <p class="card-text tw-text-xs mb-0">
                                    ...
                                    <a class="px-3 small text-right tw-text-[#D69F12] my-2  mb-0 position-relative ml-5" href="">
                                        Read more
                                    </a>
                                </p>
                            </div>
    ...
    <div class="p-5" style="background-image:url('{{ asset("assets/img/auca_logo.png") }}');  background-size: contain;background-repeat:no-repeat;background-position:center;background-color: #3B5978">

        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                <img src="{{ asset("assets/img/transparent_logo.svg") }}" class="tw-h-28 tw-w-28 tw-object-contain" alt="logo" />
                <a href="#" class="bg-white tw-h-10 tw-w-10 rounded-circle d-flex justify-content-center align-items-center">
