...
<head>
    ...
    <title>Auca Alumni | Social Activity</title>
    <style>
        .rotated {
    ...
    <div class="row">
        <div class="col-11 p-5">
            <div class="container">
                <div class="row gap-5">
                    <div class="col-5 ">
                        <img src="{{asset('assets/auca/imgs/light.svg')}}" class="img-fluid">
                        ...
                        <p class="fw-semibold">Kwibuka26: Rwandans commemorate the 1994 Genocide Against the Tutsi
        ...
        <div class="col-1 bg-primary text-center d-flex align-items-center"
             style="border-end-end-radius: 20px;border-start-end-radius: 20px;">
            <p class="rotated text-wrap text-white fw-normal">SOCIAL ACTIVITIES</p>
        </div>
    </div>
</div>
