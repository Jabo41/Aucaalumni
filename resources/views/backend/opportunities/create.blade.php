...
@section("meta")
    <title>Opportunities | Auca Alumni</title>
@stop
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a class="text-muted">Opportunities</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
...
@section('content')
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped" id="table">
                            ...
                            @foreach($opportunities as $key=>$item)
                                <tr>
                                    <td>{{++$key}}</td>
                                    <td><img src="{{asset('backend/assets/img/opportunities/'.$item->photo)}}" width="50px" height="50px" alt="no_image" class="img-fluid img-thumbnail"></td>
                                    <td>{{$item->title}}</td>
                                    <td>{{$item->date}}</td>
    ...
    <div class="modal fade" id="exampleModalLong" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog">
            <form action="{{route('opportunity.store')}}" method="post" id="submissionForm" class="submissionForm" enctype="multipart/form-data">
                @csrf
    ...
    <div class="modal fade" id="modalUpdate" data-backdrop="static" tabindex="-1" role="dialog"
         aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog">
            <form action="{{route('opportunity.update')}}" method="post" id="submissionFormEdit" class="submissionForm" enctype="multipart/form-data">
                @csrf
