...
@section("meta")
    <title>Programs | Auca Alumni</title>
@stop
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-2 mr-5">Programs</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
...
@section('content')
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Programs List</h3>
                    </div>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu " aria-labelledby="dropdownMenuButton">
                                                ...
                                                <a href="{{route('program.delete',$item->id)}}"
    ...
    <div class="modal fade" id="exampleModalLong" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog">
            <form action="{{route('programs.store')}}" method="post" id="submissionForm" class="submissionForm" enctype="multipart/form-data">
                @csrf
...
@section("scripts")
    ...
    {!! JsValidator::formRequest(\App\Http\Requests\ValidatePrograms::class,'.submissionForm') !!}
    <script>
