...
@section("meta")
    <title>Social Activities | Auca Alumni</title>
@stop
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-2 mr-5">Social Activities</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a class="text-muted">Social Activities</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
...
@section('content')
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Social Activities List</h3>
                    </div>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu " aria-labelledby="dropdownMenuButton">
                                                ...
                                                <a href="{{route('social.activity.delete',$item->id)}}"
    ...
    <div class="modal fade" id="exampleModalLong" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog">
            <form action="{{route('social.activity.store')}}" method="post" id="submissionForm" class="submissionForm" enctype="multipart/form-data">
                @csrf
    ...
    <div class="modal fade" id="modalUpdate" data-backdrop="static" tabindex="-1" role="dialog"
         aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog">
            <form action="{{route('social.activity.update')}}" method="post" id="submissionFormEdit" class="submissionForm" enctype="multipart/form-data">
                @csrf
...
@section("scripts")
    ...
    {!! JsValidator::formRequest(\App\Http\Requests\ValidateSocialActivities::class,'.submissionForm') !!}
    <script>
