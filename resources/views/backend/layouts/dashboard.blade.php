...
@section("meta")
    <title>Dashboard | Auca Alumni</title>
@stop
                    ...
                    <div class="col-lg-6 col-xxl-4">
                        ...
                        <div class="card card-custom bg-gray-100 card-stretch gutter-b">
                            ...
                            <div class="card-header border-0 bg-danger py-5">
                                <h3 class="card-title font-weight-bolder text-white">System's Stat</h3>
...
{{--                                                                        <i class="menu-icon fas fa-church"></i>--}}
                        ...
                        <div class="card card-custom card-stretch gutter-b">
                            ...
                            <div class="card-header align-items-center border-0 mt-4">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="font-weight-bolder text-dark">Some Photos of Auca Alumni</span>
                                    <span class="text-muted mt-3 font-weight-bold font-size-sm">images</span>
                                </h3>
                                ...
                                <script>
                                    document.addEventListener("DOMContentLoaded", () => {
                                        new ApexCharts(document.querySelector("#radialBarChart"), {
                                            ...
                                            label: ["admin","choir","church","executive","RUM Executive"],
                                        }).render();
                                    });
                                </script>
                ...
                {{--                Events Posted Report--}}
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-custom gutter-b">
                            <div class="card-body">
                                <h5 class="card-title">Events Posted Report</h5>
...
{{--                Request Submitted Vs Requests Approved Vs Requests Rejected--}}
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-custom gutter-b">
                            <div class="card-body">
                                ...
                                <script>
                                    document.addEventListener("DOMContentLoaded", () => {
                                        new ApexCharts(document.querySelector("#pieChart"), {
                                            ...
                                            labels: ["Approved","Rejected","Reviewed","Submitted"]
                                        }).render();
                                    });
                                </script>
                                <!-- End Pie Chart -->
