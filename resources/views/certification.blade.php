            ...
            <div class="row mb-4  mt-3">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="form-group  text-muted">
                        ...
                        <textarea class="form-control bg-light border-0" placeholder="Description" id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
                ...
                <div class="col-lg-3">
                    <select class="bg-light tw-text-left form-control border-0 mb-4">
                        <option>Type</option>
