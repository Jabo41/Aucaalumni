            ...
            <div class="row pt-5 justify-content-center">
                <div class="col-lg-6">
                    ...
                    <div class="d-flex flex-row col-9">
                        ...
                        <div class="col-sm-10 mb-4">
                            <span class="">Bio</span>
                            <textarea class="bg-light tw-text-left form-control"
                                      name="bio">{{$information->bio}}</textarea>
                        </div>
                    ...
                    <div class="d-flex flex-row col-9">
                        ...
                        <div class="col-sm-10 mb-4">
                            <input type="text" class="bg-light tw-text-left form-control border-0"
                                   value="{{$information->current_employer}}"
                    ...
                    <div class="d-flex flex-row col-9">
                        ...
                        <div class="col-sm-10 mb-4">
                            <select class="form-select text-muted bg-light border-0" name="self_employed"
                                    value="{{$information->self_employed}}">
