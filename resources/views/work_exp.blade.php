...
{{--            </div>--}}
        ...
        <div class="row">
            <div class="form-group col-4 text-muted">
        ...
        <div class="row mt-5">
            <button class="btn btn btn-outline-primary fw-bold text-[#1866B6] col-3 border-3"><span><i class="bi bi-plus"></i></span> Add experience</button>
        </div>
            <div class="row  justify-content-center mt-5">

                <button class="btn btn btn-primary btn-lg shadow tw-tracking-wider col-3 border-3">Save information</button>
        ...
        <a class="text-decoration-none fw-bold  text-muted col" href="#" > Go Back <span class="text-primary justify-content-center">home</span></a>
